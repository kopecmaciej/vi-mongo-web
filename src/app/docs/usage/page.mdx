...
In any moment you can press `?` to see the help page with all available shortcuts. Keybindings are mostly inspired by [Vim](https://www.vim.org/), but some of them are customized for efficiency.
