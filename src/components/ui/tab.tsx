    ...
    <>
      <motion.div
        className={cn(
          ...
          activeTab === value ? 'text-black dark:text-white' : 'text-gray-600 dark:text-gray-400',
          className
        )}
        onFocus={() => {
          hover && handleClick()
        ...
        {activeTab === value && (
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="absolute w-full h-full left-0 top-0 bg-white dark:bg-gray-700 rounded-md z-[1]"
            />
          </AnimatePresence>
        )}
            ...
            {activeTab === value && (
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  layoutId={defaultValue}
                  className="absolute w-full h-full left-0 top-0 bg-white dark:bg-gray-700 rounded-md z-[1] tab-shadow"
                />
              </AnimatePresence>
            )}
            {activeTab === value && (
